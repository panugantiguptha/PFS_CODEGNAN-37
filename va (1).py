...
def virtual_assistant(data):
    ...
    if "email" in data:
        ...
        to = listen().lower()
        edict = {'guppu':'panugantiguptha2004@gmail.com'} #give mail ids
        toaddr = edict[to]
        ...
        mail.starttls()
        #login
        mail.login('panugantiguptha2004@gmail.com','fugu bocw yass ndxi') #enter mailid and app password make sure you enable less secure app access
        mail.sendmail('panugantiguptha2004@gmail.com',toaddr,content) #enter your gmail username
        mail.close()
        respond('Email Sent')
...
respond("Hey trinadh how are you")
listening = True
